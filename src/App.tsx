...
import ApartmentPdfView from "./pages/apartmani/ApartmentPdfView";
          ...
          <ErrorBoundary>
            ...
            <BrowserRouter>
              <Routes>
                ...
                <Route path="/apartmani/pdf/:id" element={<ApartmentProtectedRoute><ApartmentPdfView /></ApartmentProtectedRoute>} />
